            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <table class="table-fixed w-full">
                    ...
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">Каталожный<br>номер</th>
                        <th class="px-6 py-3 text-center border-b-2 border-gray-300 text-left text-sm leading-4 tracking-wider">Название</th>
                    ...
                    @foreach(\App\Models\Product::all() as $product)
                        <tr class="bg-gray-100">
                            <td class="px-6 py-4 border-b border-gray-300 text-sm leading-5">{{ $product->id }}</td>
